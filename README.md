...
data/ ├── DICOM/ │ ├── Mag/ # Magnitude DICOM files │ ├── X-encPha/ # X-phase encoded DICOM files │ ├── Y-encPha/ # Y-phase encoded DICOM files │ └── Z-encPha/ # Z-phase encoded DICOM files ├── MAT/ │ └── *.mat # MAT files from the DENSE-Analysis toolbox (optional)
